		...
		<div class="boxprof">
			<div class="boxprof-left">
				<div class="boxprof-img">
					<img src="http://<?php echo  $_SERVER["HTTP_HOST"]; ?>/footbolfantasi/images/fonfantasy/playar02.png" alt="">
				</div>
				<div class="boxprof-text">
					<p class="title">ПЗ Марио Гётце</p>
					<p class="nameClub"><img src="http://<?php echo  $_SERVER["HTTP_HOST"]; ?>/footbolfantasi/images/fonfantasy/logoclub.png" alt="">очень длинное название клуба</p>
