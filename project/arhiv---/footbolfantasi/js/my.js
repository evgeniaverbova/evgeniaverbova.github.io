...
jQuery(function($) {
	...
	$('.country_uk.popup1').click(function(){
	   ...
	   $.arcticmodal({
	    ...
	    url: 'http://'+ location.host +'/footbolfantasi/assets/popup.php',
	...
	$('.country_es.popup1').click(function(){
	   ...
	   $.arcticmodal({
	    type: 'ajax',
	    overlay: {css: {backgroundColor: '#000',opacity: .7}},
	    url: 'http://'+ location.host +'/footbolfantasi/assets/popup2.php',
	    ajax: {
	     type: 'GET',
	     cache: false,
	     success: function(data, el, responce) {
	...
	$('.country_ua.popup1').click(function(){
	   ...
	   $.arcticmodal({
	    type: 'ajax',
	    overlay: {css: {backgroundColor: '#000',opacity: .7}},
	    url: 'http://'+ location.host +'/footbolfantasi/assets/popup3.php',
	    ajax: {
	     type: 'GET',
	     cache: false,
	     success: function(data, el, responce) {
	...
	$('.country_de.popup1').click(function(){
	   ...
	   $.arcticmodal({
	    type: 'ajax',
	    overlay: {css: {backgroundColor: '#000',opacity: .7}},
	    url: 'http://'+ location.host +'/footbolfantasi/assets/popup4.php',
		afterLoadingOnShow: function() {
	...
	$('.country_fr.popup1').click(function(){
	   ...
	   $.arcticmodal({
	    type: 'ajax',
	    overlay: {css: {backgroundColor: '#000',opacity: .7}},
	    url: 'http://'+ location.host +'/footbolfantasi/assets/popup5.php',
		afterLoadingOnShow: function() {
