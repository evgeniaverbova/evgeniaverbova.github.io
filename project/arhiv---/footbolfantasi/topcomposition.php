	...
	<div class="container-fantasy-fully">
		<div class="container-fantasy">
			...
			<div class="fantasy-left">
				...
				<div class="boxheader">
					<img src="http://<?php echo  $_SERVER["HTTP_HOST"]; ?>/footbolfantasi/images/fonfantasy/logo-fantasy.png" alt="">
					<div class="boxmenu">
						<ul>
				...
				<div class="contentbox">
						...
						<div class="team-set-up active">
							<img src="http://<?php echo  $_SERVER["HTTP_HOST"]; ?>/footbolfantasi/images/fonfantasy/team-set-up.png" alt="">
						</div>
